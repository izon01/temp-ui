  ...
  return (
    <div className="max-w-[1200px] mx-auto px-4 md:px-6 py-6 space-y-6">
      ...
      <section className="w-full">
        <button className="group relative w-full aspect-[2/1.1] md:aspect-[3/1] rounded-xl overflow-hidden active:scale-[0.98] transition-all duration-300 bg-[#0047ab] text-left shadow-lg">
          <div className="relative z-10 h-full p-6 flex flex-col justify-between">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
              <div>
                <h3 className="text-2xl font-bold text-white" style={{ fontFamily: 'Be Vietnam Pro, sans-serif' }}>오늘 출석 체크하기</h3>
                <p className="text-[#a5bdff] mt-1">버튼을 눌러 출석을 확인하세요</p>
              </div>
              <div className="bg-white text-[#00327d] px-6 py-3 rounded-xl font-bold shadow-sm group-hover:bg-[#dae2ff] transition-colors flex items-center gap-2 w-fit">
                <span>출석 체크하기</span>
      ...
      <section className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-white/80 backdrop-blur-md border border-white/30 shadow-sm p-4 rounded-xl flex flex-col gap-1">
          ...
          <span className="text-2xl font-bold text-[#003e37]" style={{ fontFamily: 'Be Vietnam Pro, sans-serif' }}>12/15</span>
        </div>
      </section>
            ...
            <div key={a.id} className={`bg-white shadow-sm rounded-xl p-6 border border-[#edeeef] ${!a.submitted ? 'group' : 'opacity-90'}`}>
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="space-y-2">
                  ...
                  <h4 className={`text-lg font-semibold ${a.submitted ? 'text-[#434653]' : 'text-[#191c1d] group-hover:text-[#00327d] transition-colors'}`} style={{ fontFamily: 'Be Vietnam Pro, sans-serif' }}>
                    {a.title}
                  </h4>
                ...
                <div className="flex items-center gap-3">
                  {a.submitted ? (
                    ...
                    <>
                      ...
                      <button className="bg-[#00327d] text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-[#0047ab] active:scale-95 transition-all shadow-sm">
                        과제 제출하기
                      </button>
                    </>
                  )}
